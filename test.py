...
class TestCalculator(unittest.TestCase):
	...
	def test_add6(self):
		...
		solution = self.app.get('/add?A=30&B=5/2')
		self.assertEqual(b'32.5', solution.data)

	def test_add7(self):

		#case 7, when A input is an alphabet(non integer) and B is integer
		solution = self.app.get('/add?A=character&B=22')
	...
	def test_add8(self):
		...
		solution = self.app.get('/add?A=22&B=character')
	...
	def test_add9(self):
		...
		solution = self.app.get('add?A=1/0&B=98')
	...
	def test_add10(self):
		...
		solution = self.app.get('add?A=10&B=2/0')
		self.assertEqual(b"None", solution.data)

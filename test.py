...
class TestCalculator(unittest.TestCase):
	...
	def test_div1(self):
		...
		solution = self.app.get('/div?A=440&B=2')
		self.assertEqual(b'220.0', solution.data)
	...
	def test_div3(self):
		...
		solution = self.app.get('/div?A=0.1&B=1.1')
		self.assertEqual(b'0.09090909090909091', solution.data)

	def test_div4(self):

		#case 4, when A is float and B is integer
		solution = self.app.get('/div?A=12.22&B=10')
		self.assertEqual(b'1.222', solution.data)

	def test_div5(self):

		#case 5, when A is integer and B is float
		solution = self.app.get('/div?A=1&B=1.2')
	...
	def test_div9(self):
		...
		solution = self.app.get('/div?A=22&B=char')
	...
	def test_div10(self):
		...
		solution = self.app.get('div?A=1/0&B=12')
		self.assertEqual(b'None', solution.data)
	...
	def test_div11(self):
		...
		solution = self.app.get('div?A=2&B=1/0')
		self.assertEqual(b'None', solution.data)
